...
#define ENC_CENTER_DIST_MM 305.0 // {mm} Distance entre chaque roue codeuse
...
#define ENC_TICKS_TO_MM 0.0966407896367954 //(2*M_PI*ENC_RADIUS)/(ENC_RESOLUTION*4) // {mm.tick^-1} (opti: a calculer apres) 
#define ENC_MM_TO_TICKS 10.347597569911164 //(ENC_RESOLUTION*4)/(2*M_PI*ENC_RADIUS) // {tick.mm^-1}
